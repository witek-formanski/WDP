...
bool do_line_segments_intersect(int a1, int a2, int b1, int b2, int* common_part_min, int* common_part_max)
{
...
bool do_rectangles_intersect(rectangle rectangle_a, rectangle rectangle_b, int* common_min_x, int* common_max_x, int* common_min_y, int* common_max_y)
{
    bool does_x_intersect = do_line_segments_intersect(rectangle_a.x1, rectangle_a.x2, rectangle_b.x1, rectangle_b.x2, common_min_x, common_max_x);
    bool does_y_intersect = do_line_segments_intersect(rectangle_a.y1, rectangle_a.y2, rectangle_b.y1, rectangle_b.y2, common_min_y, common_max_y);
