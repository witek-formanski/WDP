...
// obserwacja: dwa odcinki się przecinają, gdy końce jednego są po różnych
// stronach drugiego i vice versa
...
int which_side_of_line(line_segment line_seg, int x_point,
                       int y_point)  // 1 - above, 0 - on line, -1 - below
{
    int a, b, c;
    line(line_seg, &a, &b, &c);
...
bool do_line_segments_intersect(line_segment line_segment_1,
                                line_segment line_segment_2) {
    int a1, b1, a2, b2;
    a1 = which_side_of_line(line_segment_2, line_segment_1.x1,
                            line_segment_1.y1);
    b1 = which_side_of_line(line_segment_2, line_segment_1.x2,
                            line_segment_1.y2);
    a2 = which_side_of_line(line_segment_1, line_segment_2.x1,
                            line_segment_2.y1);
    b2 = which_side_of_line(line_segment_1, line_segment_2.x2,
                            line_segment_2.y2);
