...
bool is_point_inside_parallelogram(parallelogram parallelogram, int x_point, int y_point)
{
    int c_x_point, c_y_point;
    auto line_12 = line(parallelogram.x1, parallelogram.y1, parallelogram.x2, parallelogram.y2);
    auto line_34 = line(parallelogram.x3, parallelogram.y3, parallelogram.x4, parallelogram.y4);
    c_x_point = parallel_line_from_point(line_12, x_point, y_point).c;
    auto line_13 = line(parallelogram.x1, parallelogram.y1, parallelogram.x3, parallelogram.y3);
    auto line_24 = line(parallelogram.x2, parallelogram.y2, parallelogram.x4, parallelogram.y4);
    c_y_point = parallel_line_from_point(line_13, x_point, y_point).c;
    return is_between_or_equal(c_x_point, line_12.c, line_34.c) && is_between_or_equal(c_y_point, line_13.c, line_24.c);
}
...
bool do_parallelograms_intersect(parallelogram parallelogram_a, parallelogram parallelogram_b)
{
...
int main()
{
    ...
    std::cin >> xa1 >> ya1 >> xa2 >> ya2 >> xa3 >> ya3 >> xb1 >> yb1 >> xb2 >> yb2 >> xb3 >> yb3;
